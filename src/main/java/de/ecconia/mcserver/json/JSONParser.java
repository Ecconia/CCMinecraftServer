package de.ecconia.mcserver.json;

import java.math.BigDecimal;

import de.ecconia.mcserver.json.token.JSONToken;
import de.ecconia.mcserver.json.token.JSONTokenIterator;
import de.ecconia.mcserver.json.token.JSONType;
